#!/usr/bin/env python3
"""
Task 10: Configure Static Route (CLI/SSH version)
Category: Basis YANG-configuratie

Description: Maak een statische IPv4-route aan via SSH/CLI.
...
def main():
    ...
    print("=" * 60)
    print("Task 10: Configure Static Route")
    print("=" * 60)
