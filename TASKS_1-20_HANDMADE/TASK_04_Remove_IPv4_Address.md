...
### 3. Wat je moet zien:
Controleer dat het adres verwijderd is
...
- **File:** `task_4.py` (NETCONF version)
- **Fallback:** `task_4_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_04_Remove_IPv4_Address - Verification Documentation*  
