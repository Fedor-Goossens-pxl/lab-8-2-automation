#!/usr/bin/env python3
"""
Task 13: Configure IPv4 Address on GigabitEthernet1 (COMPLETE IMPLEMENTATION)
...
XML_PAYLOAD = """<config>
  <native xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-native">
    <username>
      ...
      <password>0</password>
      <password-text>cisco123</password-text>
    </username>
  </native>
</config>"""
...
def main():
    ...
    print("=" * 70)
    print("TASK 13: CONFIGURE IPv4 ADDRESS (VIA NETCONF/YANG)")
    print("=" * 70)
    ...
    try:
        ...
        if success:
            logger.info("Task 13 configuration applied successfully!")
