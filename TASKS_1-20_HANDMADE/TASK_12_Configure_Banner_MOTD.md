...
- **File:** `task_12.py` (NETCONF version)
- **Fallback:** `task_12_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_12_Configure_Banner_MOTD - Verification Documentation*  
