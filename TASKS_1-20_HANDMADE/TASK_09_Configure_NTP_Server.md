...
### 3. Wat je moet zien:
Zoek naar 'ntp server 193.190.230.65'
...
- **File:** `task_9.py` (NETCONF version)
- **Fallback:** `task_9_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_09_Configure_NTP_Server - Verification Documentation*  
