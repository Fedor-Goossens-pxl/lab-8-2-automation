#!/usr/bin/env python3
"""
Task 6: Configure IPv4 Address on GigabitEthernet1 (COMPLETE IMPLEMENTATION)
...
def main():
    ...
    print("=" * 70)
    print("TASK 6: CONFIGURE IPv4 ADDRESS (VIA NETCONF/YANG)")
    print("=" * 70)
    ...
    try:
        ...
        if success:
            logger.info("Task 6 configuration applied successfully!")
            ...
            # Final summary
            print("\n" + "=" * 70)
            print("FINAL SUMMARY - TASK 6 SUCCESSFUL ✓")
            print("=" * 70)
