# Task 20 Validate Configuration
...
### 3. Wat je moet zien:
Controleer Loopback0 description
...
- **File:** `task_20.py` (NETCONF version)
- **Fallback:** `task_20_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_20_Validate_Configuration - Verification Documentation*  
