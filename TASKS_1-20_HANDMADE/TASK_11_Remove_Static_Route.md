...
### 3. Wat je moet zien:
Controleer dat de route weg is
...
- **File:** `task_11.py` (NETCONF version)
- **Fallback:** `task_11_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_11_Remove_Static_Route - Verification Documentation*  
