# Task 19 Retrieve Running Config
...
### 3. Wat je moet zien:
Vergelijk output met script output
...
- **File:** `task_19.py` (NETCONF version)
- **Fallback:** `task_19_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_19_Retrieve_Running_Config - Verification Documentation*  
