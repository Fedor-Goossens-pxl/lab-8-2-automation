...
### 3. Wat je moet zien:
Zoek naar VLAN 10 met naam 'DATA'
...
- **File:** `task_15.py` (NETCONF version)
- **Fallback:** `task_15_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_15_Create_VLAN - Verification Documentation*  
