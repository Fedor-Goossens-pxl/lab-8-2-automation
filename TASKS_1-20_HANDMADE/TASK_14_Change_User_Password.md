...
### 3. Wat je moet zien:
Controleer dat secret hash is bijgewerkt
...
- **File:** `task_14.py` (NETCONF version)
- **Fallback:** `task_14_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_14_Change_User_Password - Verification Documentation*  
