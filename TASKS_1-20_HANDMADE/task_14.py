#!/usr/bin/env python3
"""
Task 14: Change Password of User fedor (COMPLETE IMPLEMENTATION)
...
instead of CLI. This demonstrates YANG model configuration for user management.
"""
...
# ============================================================
# NETCONF XML Payload - Change Password of User fedor
# CORRECTED: Use <password> instead of <secret>
# ============================================================
XML_PAYLOAD = """<config>
  <native xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-native">
    <username>
      <name>fedor</name>
      <password>newpassword456</password>
    </username>
  </native>
</config>"""
...
def apply_configuration(mgr):
    ...
    try:
        ...
        logger.info("New password: newpassword456")
        logger.info("-" * 70)
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print("✓ Password Changed: newpassword456")
            print("✓ YANG Element Used: <password> (NOT <secret>)")
            print("✓ Verification: GET running-config successful")
            print("\n✓ Next Step: Test login with new credentials:")
            print("   ssh fedor@192.168.19.139")
            print("   Password: newpassword456")
            print("=" * 70)
        else:
