...
- **File:** `task_13.py` (NETCONF version)
- **Fallback:** `task_13_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_13_Create_Local_User - Verification Documentation*  
