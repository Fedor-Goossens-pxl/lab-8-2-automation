# Task 03 Configure IPv4 Address
...
### 3. Wat je moet zien:
Zoek naar het interface IP-adres
...
- **File:** `task_3.py` (NETCONF version)
- **Fallback:** `task_3_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_03_Configure_IPv4_Address - Verification Documentation*  
