...
### 3. Wat je moet zien:
Controleer IP op GigabitEthernet1
...
- **File:** `task_18.py` (NETCONF version)
- **Fallback:** `task_18_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_18_IPv4_GigabitEthernet1 - Verification Documentation*  
