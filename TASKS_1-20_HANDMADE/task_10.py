#!/usr/bin/env python3
"""
Task 10: Configure IPv4 Address on GigabitEthernet1 (COMPLETE IMPLEMENTATION)
...
def main():
    ...
    print("=" * 70)
    print("TASK 10: CONFIGURE IPv4 ADDRESS (VIA NETCONF/YANG)")
    print("=" * 70)
    ...
    try:
        ...
        if success:
            logger.info("Task 10 configuration applied successfully!")
