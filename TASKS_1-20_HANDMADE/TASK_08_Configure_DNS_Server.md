...
### 3. Wat je moet zien:
Zoek naar 'ip name-server 8.8.8.8'
...
- **File:** `task_8.py` (NETCONF version)
- **Fallback:** `task_8_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_08_Configure_DNS_Server - Verification Documentation*  
