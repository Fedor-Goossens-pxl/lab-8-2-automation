#!/usr/bin/env python3
"""
Task 16: Configure IPv4 Address on GigabitEthernet1 via NETCONF/YANG - YANGsuite Pattern
...
Description: Configure IPv4 address on Loopback1 (10.0.0.1/24) using YANGsuite pattern.
Uses raw XML RPC dispatch (dispatch method) instead of abstracted edit_config.

Usage:
    python task_16_yangsuite.py
...
# ============================================================
# NETCONF IPv4 Configuration Payload
# Generated by YANGsuite for Loopback1 with IP 10.0.0.1/24
# ============================================================
payload = [
'''
...
def main():
    ...
    print("=" * 70)
    print("TASK 16: CONFIGURE IPv4 ADDRESS ON Loopback1")
    print("=" * 70)
    print(f"Device: {HOST}:{PORT}")
    print(f"Username: {USERNAME}")
    print(f"Interface: Loopback1")
    print(f"IPv4 Address: 10.0.0.1")
    print(f"Subnet Mask: 255.255.255.0 (/24)")
    ...
    try:
        ...
        with manager.connect(host=HOST,
            ...
            # ============================================================
            print("=" * 70)
            print("STEP 1: SEND EDIT-CONFIG RPC (Configure IPv4)")
            print("=" * 70)
            ...
            # ============================================================
            print("=" * 70)
            print("STEP 2: VERIFICATION - GET RUNNING-CONFIG (IPv4)")
            print("=" * 70)
            ...
            try:
                ...
                print("Verification Response (IPv4 Configuration):")
                print("-" * 70)
                print(verify_out)
                print("-" * 70)
                
                # Check if IPv4 is in response
                if "10.0.0.1" in verify_out and "255.255.255.0" in verify_out:
                    print("✓ IPv4 address 10.0.0.1/255.255.255.0 found in configuration!\n")
                elif "10.0.0.1" in verify_out:
                    print("✓ IPv4 address 10.0.0.1 found in configuration!\n")
                else:
                    print("⚠ IPv4 address not clearly visible in verification response\n")
