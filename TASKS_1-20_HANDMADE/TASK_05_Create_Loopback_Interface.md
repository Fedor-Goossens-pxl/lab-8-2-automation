# Task 05 Create Loopback Interface
...
```
show interface | include Loopback
```
...
- **File:** `task_5.py` (NETCONF version)
- **Fallback:** `task_5_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_05_Create_Loopback_Interface - Verification Documentation*  
