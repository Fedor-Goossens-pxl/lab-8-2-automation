...
### 3. Wat je moet zien:
Zoek naar 'hostname CSR1000v-LAB'
...
- **File:** `task_7.py` (NETCONF version)
- **Fallback:** `task_7_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_07_Change_Hostname - Verification Documentation*  
