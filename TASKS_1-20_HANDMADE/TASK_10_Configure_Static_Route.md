...
### 3. Wat je moet zien:
Zoek naar 'S*' (static) of het ingestelde netwerk
...
- **File:** `task_10.py` (NETCONF version)
- **Fallback:** `task_10_cli.py` (CLI fallback, indien NETCONF fails)
...
*TASK_10_Configure_Static_Route - Verification Documentation*  
