#!/usr/bin/env python3
"""
Task 7: Configure IPv4 Address on GigabitEthernet1 (COMPLETE IMPLEMENTATION)
...
def main():
    ...
    print("=" * 70)
    print("TASK 7: CONFIGURE IPv4 ADDRESS (VIA NETCONF/YANG)")
    print("=" * 70)
    ...
    try:
        ...
        if success:
            logger.info("Task 7 configuration applied successfully!")
