#!/usr/bin/env python3
"""
Task 5: Create Loopback Interface (CLI/SSH version)
Category: Basis YANG-configuratie

Description: Maak een loopback interface aan via SSH/CLI.
...
def main():
    ...
    print("=" * 60)
    print("Task 5: Create Loopback Interface")
    print("=" * 60)
