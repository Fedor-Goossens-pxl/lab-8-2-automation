...
Description: Verwijder de eerder aangemaakte statische route.
...
def apply_configuration(mgr):
    ...
    try:
        ...
        # Send edit-config directly to running datastore (delete operation)
...
def main():
    ...
    print("=" * 60)
    print(f"Task 11: Remove Static Route")
    print("=" * 60)
