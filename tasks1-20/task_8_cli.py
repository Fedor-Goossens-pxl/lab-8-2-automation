#!/usr/bin/env python3
"""
Task 8: Configure DNS Server (CLI/SSH version)
Category: Basis YANG-configuratie

Description: Voeg een DNS-server toe via SSH/CLI.
...
def verify_configuration():
    ...
    try:
        ...
        with ConnectHandler(**DEVICE) as net_connect:
            output = net_connect.send_command('show running-config | include name-server')
...
def main():
    ...
    print("=" * 60)
    print("Task 8: Configure DNS Server")
    print("=" * 60)
