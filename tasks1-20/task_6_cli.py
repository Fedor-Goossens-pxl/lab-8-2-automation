#!/usr/bin/env python3
"""
Task 6: Configure Loopback IP (CLI/SSH version)
Category: Basis YANG-configuratie

Description: Ken een IP-adres toe aan de loopback interface via SSH/CLI.
...
def main():
    ...
    print("=" * 60)
    print("Task 6: Configure Loopback IP")
    print("=" * 60)
