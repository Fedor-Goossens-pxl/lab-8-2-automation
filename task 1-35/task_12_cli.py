#!/usr/bin/env python3
"""
Task 12: Configure Banner MOTD (CLI/SSH version)
Category: Basis YANG-configuratie

Description: Configureer een Message of the Day-banner via SSH/CLI.
...
def verify_configuration():
    ...
    try:
        ...
        with ConnectHandler(**DEVICE) as net_connect:
            output = net_connect.send_command('show running-config | section banner')
...
def main():
    ...
    print("=" * 60)
    print("Task 12: Configure Banner MOTD")
    print("=" * 60)
