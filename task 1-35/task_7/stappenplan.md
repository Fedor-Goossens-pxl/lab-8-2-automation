# Stappenplan - Task 7: Change Hostname

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 7**: Wijzig de hostname van het toestel.

## 🎯 Doelstelling
CSR1000v-LAB configureren op N/A (System config) via NETCONF/YANG.
