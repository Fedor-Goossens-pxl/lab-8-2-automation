# Stappenplan - Task 15: Create VLAN

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 15**: Maak een VLAN aan via YANG.

## 🎯 Doelstelling
VLAN 10, name DATA configureren op VLAN 10 via NETCONF/YANG.
