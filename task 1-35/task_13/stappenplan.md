# Stappenplan - Task 13: Create Local User

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 13**: Maak een lokale gebruiker aan met een privilege level.

## 🎯 Doelstelling
user fedor, priv 15 configureren op N/A (System config) via NETCONF/YANG.
...
```
username fedor privilege 15 secret 5 $1$...
```
