...
## 🎯 Doel
Maak een ACL aan en pas deze toe op een interface.

## 📖 Uitleg
Deze oefening configureert **ACL 100, deny 10.0.0.0/24** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/ip/access-list`
...
4. **Navigeer naar**: `/native/ip/access-list`
