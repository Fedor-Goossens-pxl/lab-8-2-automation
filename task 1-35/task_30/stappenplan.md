# Stappenplan - Task 30: Configure Access Control List

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 30**: Maak een ACL aan en pas deze toe op een interface.

## 🎯 Doelstelling
ACL 100, deny 10.0.0.0/24 configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/ip/access-list`
