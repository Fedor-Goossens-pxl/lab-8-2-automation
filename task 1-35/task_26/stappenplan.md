# Stappenplan - Task 26: Configure IPv6 Address

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 26**: Ken een IPv6-adres toe aan een interface via YANG.

## 🎯 Doelstelling
2001:db8::1/64 configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/ipv6/address`
