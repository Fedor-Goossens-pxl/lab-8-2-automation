...
## 🎯 Doel
Ken een IPv6-adres toe aan een interface via YANG.

## 📖 Uitleg
Deze oefening configureert **2001:db8::1/64** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/ipv6/address`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/ipv6/address`
