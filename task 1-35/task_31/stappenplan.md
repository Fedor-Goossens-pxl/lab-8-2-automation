# Stappenplan - Task 31: Configure Interface Speed and Duplex

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 31**: Wijzig speed- en duplexinstellingen van een interface.

## 🎯 Doelstelling
1000 Mbps, full duplex configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/speed + duplex`
...
[*] Committing changes...
[+] Commit successful!
[+] Task 31 completed successfully!
