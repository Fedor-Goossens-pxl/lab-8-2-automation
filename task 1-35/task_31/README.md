...
## 🎯 Doel
Wijzig speed- en duplexinstellingen van een interface.

## 📖 Uitleg
Deze oefening configureert **1000 Mbps, full duplex** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/speed + duplex`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/speed + duplex`
