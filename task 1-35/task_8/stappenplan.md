# Stappenplan - Task 8: Configure DNS Server

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 8**: Voeg een DNS-server toe aan de configuratie.

## 🎯 Doelstelling
8.8.8.8 configureren op N/A (System config) via NETCONF/YANG.
...
**YANG Path**: `/native/ip/name-server`
