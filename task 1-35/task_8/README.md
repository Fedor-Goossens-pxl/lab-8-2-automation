...
## 🎯 Doel
Voeg een DNS-server toe aan de configuratie.

## 📖 Uitleg
Deze oefening configureert **8.8.8.8** op N/A (System config) via NETCONF/YANG.

YANG-pad: `/native/ip/name-server`
...
4. **Navigeer naar**: `/native/ip/name-server`
