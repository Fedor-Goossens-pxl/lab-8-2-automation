# Stappenplan - Task 1: Configure Interface Description

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 1**: Configureer via YANG een description op een fysieke interface.

## 🎯 Doelstelling
Link to Core Router configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/description`
