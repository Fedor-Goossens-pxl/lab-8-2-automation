# Stappenplan - Task 16: Assign Interface to VLAN

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 16**: Configureer switchport VLAN membership.

## 🎯 Doelstelling
Access VLAN 10 configureren op GigabitEthernet0/0/2 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/switchport`
