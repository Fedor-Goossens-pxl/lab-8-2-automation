...
## 🎯 Doel
Configureer switchport VLAN membership.

## 📖 Uitleg
Deze oefening configureert **Access VLAN 10** op GigabitEthernet0/0/2 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/switchport`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/switchport`
