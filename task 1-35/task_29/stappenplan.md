# Stappenplan - Task 29: Configure Interface MTU

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 29**: Wijzig de MTU-waarde van een interface.

## 🎯 Doelstelling
MTU 1500 configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/mtu`
...
```
show interfaces GigabitEthernet0/0/1 | include MTU
```
