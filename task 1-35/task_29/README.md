...
## 🎯 Doel
Wijzig de MTU-waarde van een interface.

## 📖 Uitleg
Deze oefening configureert **MTU 1500** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/mtu`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/mtu`
