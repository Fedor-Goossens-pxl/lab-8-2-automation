...
## 🎯 Doel
Verwijder een bestaand IPv4-adres van een interface.

## 📖 Uitleg
Deze oefening configureert **DELETE operation** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/ip (DELETE)`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/ip (DELETE)`
