# Stappenplan - Task 4: Remove IPv4 Address

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 4**: Verwijder een bestaand IPv4-adres van een interface.

## 🎯 Doelstelling
DELETE operation configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/ip (DELETE)`
