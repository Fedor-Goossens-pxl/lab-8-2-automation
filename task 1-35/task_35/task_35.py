...
Description: Deploy een volledige netwerkdienst (interfaces, IP-adressering, routing en ACL) in één transactie.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 35: Full Service Deployment")
    print("=" * 60)
