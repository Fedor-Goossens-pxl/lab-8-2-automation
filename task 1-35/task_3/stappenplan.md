# Stappenplan - Task 3: Configure IPv4 Address

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 3**: Ken een IPv4-adres toe aan een interface.

## 🎯 Doelstelling
10.0.0.1/24 configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/GigabitEthernet/ip/address`
