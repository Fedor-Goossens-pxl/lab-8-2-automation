...
## 🎯 Doel
Ken een IPv4-adres toe aan een interface.

## 📖 Uitleg
Deze oefening configureert **10.0.0.1/24** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `/native/interface/GigabitEthernet/ip/address`
...
4. **Navigeer naar**: `/native/interface/GigabitEthernet/ip/address`
