...
Description: Vergelijk programmatisch de running- en candidate-configuratie.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 25: Compare Running vs Candidate Configuration")
    print("=" * 60)
