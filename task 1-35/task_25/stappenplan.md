# Stappenplan - Task 25: Compare Running vs Candidate Configuration

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 25**: Vergelijk programmatisch de running- en candidate-configuratie.

## 🎯 Doelstelling
Diff output configureren op N/A (System wide) via NETCONF/YANG.
...
**YANG Path**: `get-config (both stores) + diff`
...
```
============================================================
Task 25: Compare Running vs Candidate Configuration
============================================================
