# Stappenplan - Task 20: Validate Configuration Change

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 20**: Valideer en bevestig configuratiewijzigingen.

## 🎯 Doelstelling
validate datastore configureren op N/A (NETCONF operation) via NETCONF/YANG.
...
```
Validation success/fail message
```
