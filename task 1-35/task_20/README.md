...
## 🎯 Doel
Valideer en bevestig configuratiewijzigingen.

## 📖 Uitleg
Deze oefening configureert **validate datastore** op N/A (NETCONF operation) via NETCONF/YANG.

YANG-pad: `validate RPC`
