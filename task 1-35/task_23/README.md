...
## 🎯 Doel
Pas configuraties toe op meerdere interfaces binnen één NETCONF transactie.

## 📖 Uitleg
Deze oefening configureert **Atomic transaction** op GigabitEthernet0/0/1 + 0/0/2 via NETCONF/YANG.

YANG-pad: `Multiple interfaces in single edit-config`
...
4. **Navigeer naar**: `Multiple interfaces in single edit-config`
