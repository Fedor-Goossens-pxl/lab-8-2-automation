...
Description: Pas configuraties toe op meerdere interfaces binnen één NETCONF transactie.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 23: Configure Multiple Interfaces in One Transaction")
    print("=" * 60)
