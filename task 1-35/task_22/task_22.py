...
Description: Lock de datastore vóór configuratiewijzigingen en unlock deze na afloop.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 22: Lock and Unlock Datastore")
    print("=" * 60)
