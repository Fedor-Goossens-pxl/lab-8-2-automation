...
## 🎯 Doel
Lock de datastore vóór configuratiewijzigingen en unlock deze na afloop.

## 📖 Uitleg
Deze oefening configureert **Lock → edit-config → commit → unlock** op N/A (NETCONF operation) via NETCONF/YANG.

YANG-pad: `lock/unlock RPC`
...
4. **Navigeer naar**: `lock/unlock RPC`
