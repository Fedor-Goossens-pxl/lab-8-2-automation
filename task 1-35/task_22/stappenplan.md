# Stappenplan - Task 22: Lock and Unlock Datastore

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 22**: Lock de datastore vóór configuratiewijzigingen en unlock deze na afloop.

## 🎯 Doelstelling
Lock → edit-config → commit → unlock configureren op N/A (NETCONF operation) via NETCONF/YANG.
...
```
NETCONF response success
```

### 5.3 Verwachte output
```
<ok/> lock acquired / unlock successful
```
