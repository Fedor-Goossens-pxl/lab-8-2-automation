...
## 🎯 Doel
Wijzig het wachtwoord van een bestaande gebruiker.

## 📖 Uitleg
Deze oefening configureert **New password** op N/A (System config) via NETCONF/YANG.

YANG-pad: `/native/username/password`
...
4. **Navigeer naar**: `/native/username/password`
