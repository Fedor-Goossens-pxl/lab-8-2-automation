# Stappenplan - Task 14: Change User Password

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 14**: Wijzig het wachtwoord van een bestaande gebruiker.

## 🎯 Doelstelling
New password configureren op N/A (System config) via NETCONF/YANG.
...
**YANG Path**: `/native/username/password`
...
```
username fedor privilege 15 secret 5 $1$... (new hash)
```
