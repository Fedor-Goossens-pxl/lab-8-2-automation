...
## 📖 Uitleg
Deze oefening configureert **GET operation** op N/A (Operational data) via NETCONF/YANG.

YANG-pad: `/routing-state/routing-instance/ribs (operational)`
...
4. **Navigeer naar**: `/routing-state/routing-instance/ribs (operational)`
