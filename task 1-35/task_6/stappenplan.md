# Stappenplan - Task 6: Configure Loopback IP

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 6**: Ken een IP-adres toe aan de loopback interface.

## 🎯 Doelstelling
1.1.1.1/32 configureren op Loopback0 via NETCONF/YANG.
...
**YANG Path**: `/native/interface/Loopback/ip/address`
