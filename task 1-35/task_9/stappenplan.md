# Stappenplan - Task 9: Configure NTP Server

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 9**: Configureer een NTP-server via YANG.

## 🎯 Doelstelling
pool.ntp.org configureren op N/A (System config) via NETCONF/YANG.
