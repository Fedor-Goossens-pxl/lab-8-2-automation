# Stappenplan - Task 17: Enable SNMP Community

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 17**: Configureer een SNMP read-only community.

## 🎯 Doelstelling
community 'public' RO configureren op N/A (System config) via NETCONF/YANG.
...
**YANG Path**: `/native/snmp-server/community`
