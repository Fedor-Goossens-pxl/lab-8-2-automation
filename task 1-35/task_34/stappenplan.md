# Stappenplan - Task 34: Use OpenConfig Models

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 34**: Configureer interface-instellingen met OpenConfig YANG-modellen in plaats van IOS-XE native modellen.

## 🎯 Doelstelling
OpenConfig model (vendor-neutral) configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/openconfig-interfaces:interfaces`
