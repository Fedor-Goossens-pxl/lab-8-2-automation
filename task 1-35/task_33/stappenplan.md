# Stappenplan - Task 33: Retrieve YANG Capabilities

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 33**: Haal de door het toestel ondersteunde YANG capabilities op en analyseer deze.

## 🎯 Doelstelling
List of supported YANG models configureren op N/A (NETCONF handshake) via NETCONF/YANG.
