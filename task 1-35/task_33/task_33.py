...
Description: Haal de door het toestel ondersteunde YANG capabilities op en analyseer deze.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 33: Retrieve YANG Capabilities")
    print("=" * 60)
