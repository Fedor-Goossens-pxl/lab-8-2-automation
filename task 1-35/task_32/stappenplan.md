# Stappenplan - Task 32: Execute YANG Action

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 32**: Voer een YANG action uit, bijvoorbeeld het wissen van interface counters.

## 🎯 Doelstelling
Clear interface counters configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `Cisco YANG action: clear counters`
