...
## 🎯 Doel
Voer een YANG action uit, bijvoorbeeld het wissen van interface counters.

## 📖 Uitleg
Deze oefening configureert **Clear interface counters** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `Cisco YANG action: clear counters`
...
4. **Navigeer naar**: `Cisco YANG action: clear counters`
...
# Verificatie command
show interfaces GigabitEthernet0/0/1 | include counters
```

### 🎯 Verwachte Output

```
Counters cleared on GigabitEthernet0/0/1
```
