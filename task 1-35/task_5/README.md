...
## 🎯 Doel
Maak een loopback interface aan via YANG.

## 📖 Uitleg
Deze oefening configureert **Create empty loopback** op Loopback0 via NETCONF/YANG.

YANG-pad: `/native/interface/Loopback`
...
4. **Navigeer naar**: `/native/interface/Loopback`
