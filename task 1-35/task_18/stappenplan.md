# Stappenplan - Task 18: Retrieve Interface Statistics

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 18**: Haal operationele interface-statistieken op via YANG.

## 🎯 Doelstelling
GET operation (read-only) configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `/interfaces-state/interface/statistics (operational)`
