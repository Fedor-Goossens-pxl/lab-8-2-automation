# Stappenplan - Task 21: Use Candidate Datastore

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 21**: Configureer een interface via de candidate datastore en commit de wijziging.

## 🎯 Doelstelling
edit-config to candidate, then commit configureren op GigabitEthernet0/0/1 via NETCONF/YANG.
...
**YANG Path**: `candidate datastore workflow`
...
<config>
  <native xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-native">
    <interface>
      <GigabitEthernet>
        <name>0/0/1</name>
        <description>Configured via candidate datastore</description>
      </GigabitEthernet>
    </interface>
  </native>
</config>
...
```
<ok/> commit successful from candidate
```
