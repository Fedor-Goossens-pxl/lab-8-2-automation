...
## 🎯 Doel
Configureer een interface via de candidate datastore en commit de wijziging.

## 📖 Uitleg
Deze oefening configureert **edit-config to candidate, then commit** op GigabitEthernet0/0/1 via NETCONF/YANG.

YANG-pad: `candidate datastore workflow`
...
4. **Navigeer naar**: `candidate datastore workflow`
