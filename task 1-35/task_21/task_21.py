...
Description: Configureer een interface via de candidate datastore en commit de wijziging.
...
def main():
    ...
    print("=" * 60)
    print(f"Task 21: Use Candidate Datastore")
    print("=" * 60)
