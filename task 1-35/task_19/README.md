...
## 🎯 Doel
Haal de running-config op met behulp van YANG-filters.

## 📖 Uitleg
Deze oefening configureert **GET running-config** op N/A (System wide) via NETCONF/YANG.

YANG-pad: `/native (with filter)`
...
4. **Navigeer naar**: `/native (with filter)`
