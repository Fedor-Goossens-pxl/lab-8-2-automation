# Stappenplan - Task 19: Retrieve Running Configuration

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 19**: Haal de running-config op met behulp van YANG-filters.

## 🎯 Doelstelling
GET running-config configureren op N/A (System wide) via NETCONF/YANG.
...
```
Full running configuration in XML format
```
