# Stappenplan - Task 10: Configure Static Route

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 10**: Maak een statische IPv4-route aan.

## 🎯 Doelstelling
0.0.0.0/0 via 192.168.19.1 configureren op N/A (Routing) via NETCONF/YANG.
