# Stappenplan - Task 24: Rollback Configuration

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 24**: Rol een configuratiewijziging terug na commit.

## 🎯 Doelstelling
Rollback to previous config configureren op N/A (System operation) via NETCONF/YANG.
...
**YANG Path**: `rollback / cancel-commit`
