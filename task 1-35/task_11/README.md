...
## 🎯 Doel
Verwijder de eerder aangemaakte statische route.

## 📖 Uitleg
Deze oefening configureert **DELETE operation** op N/A (Routing) via NETCONF/YANG.

YANG-pad: `/native/ip/route (DELETE)`
...
4. **Navigeer naar**: `/native/ip/route (DELETE)`
