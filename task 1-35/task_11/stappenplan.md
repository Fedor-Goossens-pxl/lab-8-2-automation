# Stappenplan - Task 11: Remove Static Route

## 📋 Overzicht
Deze gids leidt je stap-voor-stap door **Task 11**: Verwijder de eerder aangemaakte statische route.

## 🎯 Doelstelling
DELETE operation configureren op N/A (Routing) via NETCONF/YANG.
...
**YANG Path**: `/native/ip/route (DELETE)`
